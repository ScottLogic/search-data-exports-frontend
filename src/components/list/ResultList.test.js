...
describe('<ResultList />', () => {
  ...
  const testData = [
    ...
    },
    {
        "_index": "posts",
        "_type": "post",
        "_id": "-CEH0msBcSVQ8Ni1lRpT",
        "_score": 1.0,
        "_source": {
            "UserID": "65",
            "DateCreated": "2018-07-20T14:23:28.505Z",
            "Content": "What was the person thinking when they discovered cow's milk was fine for human consumptionâ€¦ and why did they do it in the first place!?",
            "Tags": [
                "#democratic",
                "#crusade",
                "#progress",
  ...
  it('Renders the correct UserID for the first element', () => {
    const userIDNode = wrapper.find('.container-result-row-user-date div').first().getElement();
  ...
  it('Renders the correct DateCreated for the first element', () => {
    const dateCreatedNode = wrapper.find('.container-result-row-user-date div').getElements()[1];
  ...
  it('Renders the correct content for the first element', () => {
    const contentNode = wrapper.find('.container-result-row-content').first().getElement();
  ...
  it('Renders the correct tags for the first element', () => {
    const tagsNode = wrapper.find('.container-result-row-tags').first().getElement();
